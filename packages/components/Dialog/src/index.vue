  ...
  <div>
    ...
    <teleport to="body">
      ...
      <transition name="upsd">
        <div class="dialog" v-if="modelValue" id="dialog" :style="draggable ? {top: top+'px', left: left+'px'} : {}">
          <div class="title" v-if="title" @mousedown="startDrag" @mouseup="stopDrag">{{ title }}</div>
          <div class="msg">
            <slot />
          </div>
          <div class="btn-group">
